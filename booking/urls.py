...
urlpatterns = [
    ...
    path('view_booking/', views.ViewBookingsView.as_view(), name='view_booking'),
    ...
    path('cancel_booking/<int:booking_id>/', views.CancelBookingView.as_view(), name='cancel_booking'),
