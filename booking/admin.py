...
class BookingsAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'booking_date', 'booking_time', 'table', 'user', "is_cancelled")
    list_filter = (
        'booking_date', 'booking_time', 'table', 'user', "is_cancelled")


class CustomUserAdmin(admin.ModelAdmin):
    list_display = (
        'email', 'full_name', 'username', 'is_staff',
        'membership_id', 'is_membership_approved')
    list_filter = (
